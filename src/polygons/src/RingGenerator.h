...
class RingGenerator
{
  public:
    ...
    RingGenerator(std::shared_ptr<types::OccupancyMap2D const> map, double radiusOuterCircle, double radiusCheckCircle,
  ...
  private:
    std::shared_ptr<types::OccupancyMap2D const> m_map;
